...
// MongoDB bağlantısı
const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://kitapsever:kitapsever123@cluster0.mongodb.net/kitapsever?retryWrites=true&w=majority";
...
// Ana sayfa
app.get('/', (req, res) => {
  res.json({ message: 'Kitapsever API çalışıyor' });
});

// JWT Secret key'i ayarla
process.env.JWT_SECRET = process.env.JWT_SECRET || 'kitapsever-gizli-anahtar';
